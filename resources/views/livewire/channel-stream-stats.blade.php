<div class="grid gap-6">
  @foreach ($streamStats as $streamStat)
    <div class="bg-gray-50 dark:bg-gray-800 border border-gray-50 dark:border-gray-700 rounded-xl py-2 overflow-x-auto">
      ...
      <div>
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="bg-gray-50 dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
