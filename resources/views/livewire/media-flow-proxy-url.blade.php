...
<div>
     <div>
        ...
        <div class="fi-fo-field-wrp-helper-text break-words text-sm text-gray-500 mt-1">
            To disable clear the MediaFlow Proxy values from the app <a href="{{ url('preferences?tab=-proxy-tab') }}" class="text-indigo-500 hover:underline hover:text-indigo-600 dark:hover:text-indigo-400">Settings</a> page.
        </div>
    </div>
</div>
