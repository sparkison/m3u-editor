<div class="space-y-4">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end">
        <div class="flex-1">
            <label for="vod-search" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Search</label>
            <input
                id="vod-search"
        ...
        <div class="w-48">
            <label for="vod-genre" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Genre</label>
            <select
                id="vod-genre"
        ...
        <div class="w-32">
            <label for="vod-perPage" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Per page</label>
            <select
                id="vod-perPage"
            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                @forelse($vods as $vod)
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">{{ $vod->name }}</td>
    ...
    <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
        ...
        <div class="flex items-center gap-4">
            ...
            <button
                ...
                type="button"
                class="inline-flex items-center gap-2 rounded-lg bg-success-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-success-500 focus:outline-none focus:ring-2 focus:ring-success-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
            >
