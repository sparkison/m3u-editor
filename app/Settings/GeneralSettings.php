...
class GeneralSettings extends Settings
{
    ...
    public ?string $sync_performance_profile = 'auto'; // auto, low, medium, high, ultra

    public ?int $sync_custom_metadata_chunk_size = 0; // 0 = use profile default

    public ?int $sync_custom_strm_chunk_size = 0; // 0 = use profile default

    public ?int $sync_custom_cleanup_chunk_size = 0; // 0 = use profile default
